...
- **Не закрыто:** реальные URL для чипов Publications — нужно сверить с доской Miro (есть ли там
  гиперссылки внутри рамок); ждём авторизации Miro MCP. Унификация визуального веса WhatsApp-иконки —
  опционально (отличие минимально).

> Следующий шаг: сверить ссылки Publications с Miro (после авторизации MCP), затем деплой/контент.
